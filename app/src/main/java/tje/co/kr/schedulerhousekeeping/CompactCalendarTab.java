...
public class CompactCalendarTab extends Fragment {
    ...
    private Button setlocale;
    private Button removeallevents;
    private LinearLayout calendarcontrolbuttons;
    private Button slidecalendar;
    private Button showwithanimationcalendar;
    private LinearLayout calendarcontrolbuttons2;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        this.maincontent = (LinearLayout) v.findViewById(R.id.maincontent);
        this.bookingslistview = (ListView) v.findViewById(R.id.bookings_listview);
        this.calendarcontrolbuttons2 = (LinearLayout) v.findViewById(R.id.calendar_control_buttons_2);
        this.showwithanimationcalendar = (Button) v.findViewById(R.id.show_with_animation_calendar);
        this.slidecalendar = (Button) v.findViewById(R.id.slide_calendar);
        this.calendarcontrolbuttons = (LinearLayout) v.findViewById(R.id.calendar_control_buttons);
        this.removeallevents = (Button) v.findViewById(R.id.remove_all_events);
        this.setlocale = (Button) v.findViewById(R.id.set_locale);
        this.nextbutton = (Button) v.findViewById(R.id.next_button);
        this.prevbutton = (Button) v.findViewById(R.id.prev_button);
        this.compactcalendarview = (CompactCalendarView) v.findViewById(R.id.compactcalendar_view);
    ...
    private void openCalendarOnCreate(View v) {
        final LinearLayout layout = (LinearLayout) v.findViewById(R.id.maincontent);
